...
| `#md-table`                            | positional column count and cells                    | a full-width prose table. The positive column count and cell array must form complete rows; the first row is the semantic header. Compact leading columns fit their contents, the final column fills the remaining width, and only internal horizontal rules are drawn.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
